    ...
    <div id="content_sec">
    	...
    	<div class="col2">
            ...
            $kategori=mysql_query("select nama_kategori, kategori.id_kategori, kategori_seo,  
								  ...
								  where kategori_induk ='0'
                                  group by nama_kategori");
            $no=1;
            while($k=mysql_fetch_array($kategori)){
              if(($no % 2)==0){ //$k[nama_kategori] ($k[jml])
                //echo "<li><a href='kategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";
				echo "<li><a href='ikategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";
              }
              else{ //$k[nama_kategori] ($k[jml])
			  	//echo "<li><a href='kategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";   
                echo "<li><a href='ikategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";              
              }
              $no++;
...
<!---- merk --->
		  <div class="myaccount">
                ...
                <ul>
                  ...
                  <?php
            $merk=mysql_query("SELECT * FROM merk GROUP BY merk_nama ORDER BY RAND() LIMIT 10");
            $no=1;
            while($mr=mysql_fetch_array($merk)){
              if(($no % 2)==0){ //$k[nama_kategori] ($k[jml])
                //echo "<li><a href='kategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";
				echo "<li><a href='ikategori-$k[id_kategori]-$k[kategori_seo].html'> $mr[merk_nama]</a></li>";
              }
              else{ //$k[nama_kategori] ($k[jml])
			  	//echo "<li><a href='kategori-$k[id_kategori]-$k[kategori_seo].html'> $k[nama_kategori]</a></li>";   
                echo "<li><a href='ikategori-$k[id_kategori]-$k[kategori_seo].html'> $mr[merk_nama]</a></li>";              
...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	IstanaBelanja.com adalah online, yang menyediakan segala kebutuhan fashion anda. Griya Gaya ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja fashion berkualias dengan harga yang terjangkau.            </p>
        ...
        <div class="contactus">
            ...
            <ul>
                ...
                <li class="email"><span class="bold">Email:</span> <a href="mailto:rizal_fzl@yahoo.com">rizal_fzl@yahoo.com</a></li>
                <li class="skype"><span class="bold">Skype:</span> rizalfaizal</li>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="copyright_network">
        	<p>Copyright ©2011 Develoved by: Rizal Faizal </p>
            <ul class="network"><li>
